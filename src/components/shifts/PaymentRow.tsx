...
import { formatDate, formatDuration } from '@/domain/datetime'
...
export function PaymentRow({ view, onOpen, onRegister, selection }: PaymentRowProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {payment && (
          <span className="payment-row__term">
